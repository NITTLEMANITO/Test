# Test + Companion + Custom Provider Example

This example uses @Test/companion with a dummy custom provider.
...
corepack yarn build
corepack yarn workspace @Test-example/custom-provider start
```
