# Test + AWS S3 with Node.JS

A simple and fully working example of Test and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @Test-example/aws-nodejs start
```
